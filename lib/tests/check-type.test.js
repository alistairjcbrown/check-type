...
(function(chai, check) {
    ...
    suite("Check Type", function() {
        ...
        setup(function() {
            ...
            // Clear existing type checking functions
            check.clear();
        ...
        suite("init", function() {
            ...
            test("should throw error if functions object is not provided", function() {
                expect(function() {
                    check.init();
                }).to.throw(Error);
            });
        ...
        suite("Is function", function() {
            ...
            test("should return boolean for empty", function() {
                var type = "empty";
                expect(check("test").is(type)).to.false;
            ...
            test("should return boolean for string", function() {
                var type = "string";
                expect(check(123).is(type)).to.false;
        ...
        suite("Has function", function() {
            ...
            test("should return true when path exists", function() {
                var has_path = check(object_fixture).has("hello.world.foo.bar");
                expect(has_path).to.be.true;
            });

            test("should return false when path does not exit", function() {
                var has_path = check(object_fixture).has("hello.everyone.foo.bar");
                expect(has_path).to.be.false;
            });
